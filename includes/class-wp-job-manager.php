...
class WP_Job_Manager {
	...
	public function frontend_scripts() {
		...
		wp_register_script( 'wp-job-manager-company-data', JOB_MANAGER_PLUGIN_URL . '/assets/js/company-data.js', array( 'jquery' ), JOB_MANAGER_VERSION, true );
		wp_localize_script( 'wp-job-manager-company-data', 'job_manager_ajax_company_data', $ajax_data );
